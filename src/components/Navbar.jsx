        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1 gap-3">
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center p-2 border-b-2 transition-colors duration-200 ${
                  isActive
                    ? "font-bold border-[#632EE3]/60 text-[#632EE3]"
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "font-bold border-b-2 border-gray-300 text-[#632EE3]"
                  : ""
              }
            >
            ...
            <NavLink
              to="/installation"
              className={({ isActive }) =>
                isActive ? "font-bold border-b-2 border-gray-300" : ""
              }
            >
              <div className="flex items-center p-2 text-gray-500">
                <MdInstallDesktop size={20} />{" "}
                <p className="ml-2">Installation</p>
              </div>
            </NavLink>
          </ul>
        </div>
        <div className="navbar-end">
          <NavLink to={"https://github.com/rabbi007"}>
            {" "}
            <button className="flex items-center gap-2 bg-gradient text-white px-3 py-2 rounded-sm shadow-2xl font-semibold">
              {" "}
              <FaGithub /> Contribute
            </button>{" "}
          </NavLink>
